...
const Griditems1 = styled('div')({
  width: 400, border: "1px solid #ddd", height: 75,
});
const Griditems2 = styled('div')({
  width: 410, border: "1px solid #ddd", height: 75,
});
const Griditems3 = styled('div')({
  width: 430, border: "1px solid #ddd", height: 75,
});
            ...
            <Grid item  >
              <Containers>
                <Box  >
                  ...
                  <Tf>
                    <TextField fullWidth label='Enter Training Name' size='small' ></TextField>
                  </Tf>
                </Box>
            ...
            <Grid item  >
              <Containers>
                <Box  >
                  ...
                  >
                    <Tfbox>
                      <TextField fullWidth label='Enter your Justification' size='small' ></TextField>
                    </Tfbox>
                    <div>
