...
const Performancefeedbacksummary = (props: any) => {
  //@ts-ignore
  const {fData,appraiserFeedback,setAppraiserFeedback,overallFeed,setOverallFeed,isLoading,empData,feedbackLoading,areaImprovement,setAreaImprovement,area,setarea,
  } = useReviewerContext();
    ...
    if (fData && empData) {
      setOverallFeedback(() => {
        const filter = fData.data.map((i: any) => {
          return empData.data.reviewer.feedback_questions.filter((j: any) => {
            if (j.name) {
        ...
        <div>
          ...
          <Box sx={{ flexGrow: 1 }}>
            <Grid container spacing={3}>
              ...
              {/*      return (*/}
              {/*        <>*/}
              {/*          /!*<Typo2>Reviewer {j.name.name} </Typo2>*!/*/}
              {/*          /!*<Tf1>*!/*/}
              {/*          /!*  <Box>*!/*/}
              {/*          /!*    <TextField*!/*/}
              {/*          /!*      fullWidth*!/*/}
