...
const RTrecommandation = (props: any) => {
    ...
    // @ts-ignore
    const { trainingRecommendation, trainingRecommendationComments, setTrainingRecommendationComments, trainingSelectValue, trainingRecommendationFormValues, setTrainingRecommendationFormValues
    } = useReviewerContext()
    ...
    // useEffect(() => {
    //     setTrainingRecommendationComments(trainingComments);
    // }, [trainingComments]);

    return (
        <div>
            <TrainingRecommendations>
                Reviewer Training Recommendation(s) Comments
            </TrainingRecommendations>
            <Contain>
