...
const Footerbuttons = (props: any) => {
    //@ts-ignore
    const {updateMutation, otherRecommendation, checkboxIdHandler, checkboxHandler, employee_id, trainingRecommendationFormValues, overallFeed, areaImprovement, isLoading, empData} = useAppraiserRejectsNormalizerContext()
    ...
    return (
        ...
        <Stack justifyContent="center" spacing={3} direction="row">
            <Button
                ...
                onClick={() => appraiserAcceptNormalizer(employee_id)}
