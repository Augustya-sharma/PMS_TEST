...
export default function NormalizerRating() {
    // @ts-ignore
    const {empData: employeeData,employee_id} = useAppraiserRejectsNormalizerContext()
                                                ...
                                                <>

                                                    {
                                                        ((employeeData && employeeData.data.normalizer.objective_description.filter(
                                                            (i: any) => i.name._id === j.name._id
                                                        ).map((k: any) => k.ratings._id)[0]) !== (employeeData && employeeData.data.appraisal.objective_description
                                                            .filter(
                                                                (i: any) => i.name._id === j.name._id
