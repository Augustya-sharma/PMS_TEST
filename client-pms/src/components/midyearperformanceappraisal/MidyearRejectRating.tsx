      ...
      <div style={{ backgroundColor: "#F1F1F1", height: "900px" }}>
        ...
        >
            ...
            <Grid container spacing={2} columns={16}>
              ...
              <Grid item xs={8}>
                <Item style={{ textAlign: "right", color: "#ade9f3" }}>
                  <Link to={MIDYEAR_CHECKBOX}>
                    <Add style={{ verticalAlign: "middle" }} /> Add More
                  </Link>
                </Item>
              </Grid>
            </Grid>
          ...
          <Box sx={{ flexGrow: 1 }}>
            <Grid container spacing={2} columns={16}>
              {/* {remove && ( */}
              {employeeData && employeeData.data.rejected.map((i: any,index:any) => {
                return (
                  <>
                    <Grid item xs={8}>
                      <Item>
                            ...
                            >
                              ...
                              <TableRow>
                                ...
                                <TableCell>
                                  ...
                                  <p>{i.name.detailed_description}</p>
                                </TableCell>
                                ...
                                <TableCell component="th" scope="row">
                                  ...
                                  <InputLabel>Your Ratings</InputLabel>
                                    <Select
                                      ...
                                      variant="standard"
                                      onChange={(e) => {
                                        setRating1(employeeData.data.rejected.map((previousState:any, ix: any)=> {
                                          return {
                                            ...previousState,
